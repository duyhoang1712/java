...
public class ListStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbClass.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Táº¥t cáº£" }));
    ...
    private void tbStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbStudentMouseClicked
        ...
        student = new Student();
        student = studentDAO.getItemClassName((Integer) tbDefaultStudent.getValueAt(row, 0)); // láº¥y sinh viÃªn cÃ³ id táº¡i Ä‘iá»ƒm click
